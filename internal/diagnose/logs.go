...
// exercises. Callers supply already-validated, canonical start/end values;
// limit/direction are passed through when non-empty. No range/size cap is
// imposed here, the caller decides.
