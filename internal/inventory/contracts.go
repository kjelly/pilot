...
var roleContracts = []roleContract{
	...
	{Name: "dcgm-exporter", Description: "GPU 主機的監控 agent，NVIDIA dcgm-exporter，需先過 docker，沒有 GPU 的主機自動優雅跳過 (dcgm-exporter-apply.yml)", GroupVarsStem: "dcgm-exporter", VaultSections: []string{"dcgm-exporter-auth"}},
