...
func TestLintContractsLoadsCanonicalDirectory(t *testing.T) {
	...
	for _, component := range []string{
		...
		"freeipa-client", "freeipa-dns", "freeipa-identity", "freeipa-nfs-client", "freeipa-nfs-server", "freeipa-server-replica",
	...
	if !strings.Contains(got, "contracts: 25 component(s) loaded from") {
