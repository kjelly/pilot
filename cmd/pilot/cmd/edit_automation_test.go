...
func TestValidateEditScenarioRejectsInvalidInput(t *testing.T) {
	tests := []struct {
		...
		{name: "add_annotation missing key", s: editScenario{Version: 1, Steps: []editAction{{Action: "add_annotation", Host: "web-1", Value: "1"}}}, want: "key"},
		{name: "add_annotation missing value", s: editScenario{Version: 1, Steps: []editAction{{Action: "add_annotation", Host: "web-1", Key: "project"}}}, want: "value"},
		{name: "add_annotation rejects value_env", s: editScenario{Version: 1, Steps: []editAction{{Action: "add_annotation", Host: "web-1", Key: "project", Value: "alpha", ValueEnv: "X"}}}, want: "value_env"},
		{name: "add_annotation invalid key", s: editScenario{Version: 1, Steps: []editAction{{Action: "add_annotation", Host: "web-1", Key: "Project", Value: "alpha"}}}, want: "invalid"},
		{name: "add_annotation secret-like key", s: editScenario{Version: 1, Steps: []editAction{{Action: "add_annotation", Host: "web-1", Key: "api_key", Value: "alpha"}}}, want: "secret-bearing"},
		{name: "delete_annotation missing key", s: editScenario{Version: 1, Steps: []editAction{{Action: "delete_annotation", Host: "web-1"}}}, want: "key"},
