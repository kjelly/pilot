...
var aptUpdateCacheAllowlist = map[string]string{
	...
	"playbooks/apply/docker-apply.yml":               "not yet migrated — docs/tmp/now/spec.md §16 Phase 2",
	"playbooks/apply/log-server-apply.yml":           "not yet migrated — docs/tmp/now/spec.md §16 Phase 2",
	"playbooks/apply/reverse-proxy-apply.yml":        "not yet migrated — docs/tmp/now/spec.md §16 Phase 2",
	"playbooks/apply/restic-backup-apply.yml":        "not yet migrated — docs/tmp/now/spec.md §16 Phase 2",
	"playbooks/apply/core-infra-provider-apply.yml":  "not yet migrated — docs/tmp/now/spec.md §16 Phase 2 (dns-C1 unbound, ntp-C4 chrony)",
	"playbooks/apply/host-monitoring-apply.yml":      "not yet migrated — docs/tmp/now/spec.md §16 Phase 2",
	"playbooks/apply/pam-oidc-sshd-apply.yml":        "not yet migrated — docs/tmp/now/spec.md §16 Phase 2",
